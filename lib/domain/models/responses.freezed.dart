...
mixin _$Failure {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(
            @JsonKey(name: "cod") int? statusCode, String? message)
        httpError,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(@JsonKey(name: "cod") int? statusCode, String? message)?
        httpError,
...
abstract class $FailureCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: "cod") int? statusCode, String? message});
}
...
class _$HttpErrorImpl implements _HttpError {
  ...
  @override
  String toString() {
    return 'Failure.httpError(statusCode: $statusCode, message: $message)';
  }
...
abstract class _HttpError implements Failure {
  const factory _HttpError(
      {@JsonKey(name: "cod") required final int? statusCode,
